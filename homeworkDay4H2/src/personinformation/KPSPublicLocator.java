...
public class KPSPublicLocator extends org.apache.axis.client.Service implements personinformation.KPSPublic {
    ...
    private java.lang.String KPSPublicSoap_address = "https://person.information/Service/KPSPublic.asmx";
    ...
    public personinformation.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public personinformation.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	personinformation.KPSPublicSoapStub _stub = new personinformation.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (personinformation.KPSPublic.class.isAssignableFrom(serviceEndpointInterface)) {
            	personinformation.KPSPublicSoapStub _stub = new personinformation.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://person.information", "KPSPublic");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://person.information", "KPSPublicSoap"));
        }
