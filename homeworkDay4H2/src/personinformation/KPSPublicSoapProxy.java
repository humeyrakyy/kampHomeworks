...
public class KPSPublicSoapProxy implements personinformation.KPSPublicSoap {
	  private String _endpoint = null;
	  private personinformation.KPSPublicSoap kPSPublicSoap = null;
	  ...
	  private void _initKPSPublicSoapProxy() {
	    try {
	      kPSPublicSoap = (new personinformation.KPSPublicLocator()).getKPSPublicSoap();
